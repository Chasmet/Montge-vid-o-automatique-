...
function musicProjectTemplate() {
  ...
  return panel(
    "Projet musique",
    "Montage stable avec ordre des médias.",
    `
      <form id="musicProjectForm" class="stack-form">
        ...
        <div class="result-box">
          <div class="result-box-head">
            ...
            <button class="chip-btn" type="button" data-action="open-library" data-mode="music" data-type="${draft.mode === "video" ? "video" : "image"}">Bibliothèque</button>
          </div>
    ...
    `
      <form id="speechProjectForm" class="stack-form">
        ...
        <div class="result-box">
          <div class="result-box-head">
            <h3>Médias disponibles</h3>
            <button class="chip-btn" type="button" data-action="open-library" data-mode="speech" data-type="${draft.mode === "video" ? "video" : "image"}">Bibliothèque</button>
          </div>
