...
function buildMusicSelectionReasoning(draft, lockedCount, finalCandidates = []) {
  ...
  if (lockedCount > 0) {
    return `${lockedCount} média(s) imposé(s) par toi en tête, puis complément IA avec variation ${variation}. Total retenu : ${count}.`;
  }

  return `Sélection IA diversifiée avec variation ${variation}. Total retenu : ${count}.`;
}
