const APP_NAME = "Application personnelle";
const DB_NAME = "montage-ia-mobile-stable-v3";
const DB_VERSION = 1;
  ...
  return `
    <section class="screen">
      <div class="hero-card">
        ...
        <p class="hero-text">Admin pour gérer l’application. Yvane et Nelvyn ont leur compte séparé.</p>
      </div>
      ...
      <div class="profile-grid">
        ...
        <button class="profile-card" data-action="enter-profile" data-profile="user1">
          ...
          <span class="profile-desc">Ses projets, ses médias, ses créations</span>
        </button>
        ...
        <button class="profile-card" data-action="enter-profile" data-profile="user3">
          ...
          <span class="profile-desc">Espace libre pour tests</span>
        </button>
      </div>
    </section>
  `;
  ...
  return `
    <section class="screen">
      <div class="hero-card">
        ...
        <p class="hero-text">Choisis une action simple : créer une voix, créer une vidéo, ou préparer des prompts vidéo.</p>
      </div>
      ...
      <div class="action-grid">
        <button class="action-card" data-action="go-route" data-route="speechProject">
          ...
          <span class="action-desc">Écris un texte, choisis une voix, puis crée une vidéo</span>
        </button>

        <button class="action-card" data-action="go-route" data-route="musicProject">
          <span class="action-icon">🎵</span>
          <span class="action-title">Montage musique</span>
          <span class="action-desc">Ajoute une musique, choisis des médias, puis crée la vidéo</span>
        </button>

        <button class="action-card" data-action="go-route" data-route="sora">
          <span class="action-icon">✨</span>
          <span class="action-title">Prompts vidéo</span>
          <span class="action-desc">Découpe l’audio et génère des prompts 10 s ou 15 s</span>
        </button>

        <button class="action-card" data-action="open-library" data-mode="music" data-type="image">
          <span class="action-icon">🖼️</span>
          <span class="action-title">Médias musique</span>
          <span class="action-desc">Images et vidéos pour les projets musique</span>
        </button>

        <button class="action-card" data-action="open-library" data-mode="speech" data-type="image">
          <span class="action-icon">🎬</span>
          <span class="action-title">Médias voix</span>
          <span class="action-desc">Images et vidéos pour les projets voix IA</span>
        </button>
...
function musicProjectTemplate() {
  ...
  return panel(
    "Montage musique",
    "1. Ajoute la musique - 2. Choisis les médias - 3. Choisis automatique ou manuel - 4. Crée la vidéo.",
    `
      <form id="musicProjectForm" class="stack-form">
        ...
        <div class="row-2">
          ...
          <label class="field">
            <span>Comment créer la vidéo ?</span>
...
function speechProjectTemplate() {
  ...
  return panel(
    "Voix IA",
    "1. Écris ton texte - 2. Choisis la voix - 3. Ajoute des médias - 4. Choisis automatique ou manuel - 5. Génère.",
    `
...
function libraryTemplate() {
  return panel(
    "Médias",
    "Ajoute, ouvre, puis supprime tes images et vidéos.",
    `
...
function projectsTemplate() {
  return panel(
    "Mes projets",
    "Reprendre, créer une vidéo, télécharger ou exporter.",
    `
  ...
  return panel(
    ...
    `
      ...
      <div class="result-box">
        ...
        <p class="small-note">Mode vidéo : ${montageModeLabel(project.config?.montageMode)}</p>
      ...
      <article class="project-card">
        <div class="project-card-top">
          <div>
            ...
            <div class="small-note">${projectTypeLabel(project.type)}</div>
          </div>
